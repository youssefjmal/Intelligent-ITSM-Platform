...
const translations = {
  ...
  "tickets.search": { fr: "Rechercher par titre, ID, assigne ou envoyeur...", en: "Search by title, ID, assignee or sender..." },
  ...
  "tickets.reporter": { fr: "Envoye par", en: "Sent by" },
  ...
  "form.similarCommentSuggestions": {
    fr: "Suggestions basees sur commentaires similaires (embeddings)",
    en: "Suggestions based on similar comments (embeddings)",
  },
  "form.llmSuggestions": { fr: "Suggestions supplementaires generees par le LLM", en: "Additional suggestions generated by LLM" },
  ...
  "status.waitingForCustomer": { fr: "En attente client", en: "Waiting for Customer" },
  "status.waitingForSupportVendor": { fr: "En attente support/fournisseur", en: "Waiting for Support/Vendor" },
