...
const translations = {
  ...
  "chart.typeBreak": { fr: "Tickets par Type ITIL", en: "Tickets by ITIL Type" },
  ...
  "tickets.allTypes": { fr: "Tous les types", en: "All types" },
  ...
  "tickets.loading": { fr: "Chargement des tickets...", en: "Loading tickets..." },
  "tickets.loadingHint": { fr: "Le backend repond, les donnees arrivent.", en: "The backend is responding and data is loading." },
  "tickets.authRequired": { fr: "Connectez-vous pour voir les tickets.", en: "Sign in to view tickets." },
  "tickets.authRequiredHint": { fr: "La liste des tickets est protegee par l'authentification.", en: "The tickets list requires authentication." },
  "tickets.loadError": { fr: "Impossible de charger les tickets.", en: "Unable to load tickets." },
  "tickets.loadErrorHint": { fr: "Verifiez la session, l'API locale et les logs backend.", en: "Check your session, local API, and backend logs." },
  "tickets.filterHint": { fr: "Essayez de modifier les filtres ou la recherche.", en: "Try adjusting filters or search terms." },
  ...
  "form.aiClassifyDesc": { fr: "L'IA analysera le contenu pour suggerer la priorite, le type et la categorie", en: "AI will analyze the content to suggest priority, type, and category" },
  "form.priority": { fr: "Priorite", en: "Priority" },
  "form.type": { fr: "Type ITIL", en: "ITIL Type" },
  ...
  "form.suggestedType": { fr: "Type suggere", en: "Suggested type" },
  ...
  "form.aiHelpDesc": { fr: "Remplissez le titre et la description, puis cliquez sur \"Classification IA\" pour obtenir des suggestions automatiques de priorite, type, categorie, et des recommandations basees sur les tickets precedents.", en: "Fill in the title and description, then click \"AI Classification\" to get automatic suggestions for priority, type, category, and recommendations based on previous tickets." },
  ...
  "type.incident": { fr: "Incident", en: "Incident" },
  "type.service_request": { fr: "Demande de service", en: "Service Request" },
  ...
  "detail.aiSuggestedType": { fr: "Type suggere", en: "Suggested type" },
  ...
  "detail.similarTicketsDesc": {
    fr: "Tickets proches detectes via similarite semantique (titre + description) dans la meme categorie.",
    en: "Closest tickets detected via semantic similarity (title + description) within the same category.",
  },
  ...
  "chat.ticketType": { fr: "Type", en: "Type" },
  ...
  "recs.search": { fr: "Rechercher par ID, titre ou ticket...", en: "Search by ID, title or ticket..." },
  "recs.filterImpact": { fr: "Impact", en: "Impact" },
